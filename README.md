Another personal project that I challenged myself for creating a simple language using C language and a garbage collector, without using any of the LLM's, copy paste, auto compilation tools.
